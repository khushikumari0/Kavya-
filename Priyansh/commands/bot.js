  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf  𝐊𝐇𝐔𝐒𝐇𝐈  dekh sak thi hai Mujhe💞", threadID);
     };
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
       return api.sendMessage("Kya itna buri hoon main Ke AP Mujhe I hate you bol rahe ho ja main tujh se bat Nahi Kar thi😪😪😥😢", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "KHUSHI") || (event.body.toLowerCase() == "KHUSHI")) {
       return api.sendMessage("Boss busy hai Mujse bat Karo 🙄", threadID);
     };
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
       return api.sendMessage("Janu me serf KHUSHI ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     if ((event.body.toLowerCase() == "boss") || (event.body.toLowerCase() == "shaan oye")) {
       return api.sendMessage("Prefix Kon Lagayega garab insan? Pehle Prefix Lagao Fir Likho KHUSHI boss", threadID);
     };
     if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello")) {
       return api.sendMessage("Next Hi/Hello nhi JAI SHREE RAM Bola kro Okay 💖", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
       ...
       if ((event.body.toLowerCase() == "Kavya Kon ho ap") || (event.body.toLowerCase() == "kavya ap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye both Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo Khushi se rabta karo👍👍💕" , threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Shaan ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞𝐊𝐇𝐔𝐒𝐇𝐈 𝐊𝐔𝐌𝐀𝐑𝐈🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐊𝐇𝐔𝐒𝐇𝐈 . ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/Khushi.00007686☞    ", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("𝐊𝐇𝐔𝐒𝐇𝐈 𝐊𝐔𝐌𝐀𝐑𝐈 𝐔𝐫𝐟 Khushi   ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝐊𝐇𝐔𝐒𝐇𝐈 𝐊𝐔𝐌𝐀𝐑𝐈. He Gives his name mr 𝐊𝐇𝐔𝐒𝐇𝐈  everywhare", threadID);
     };
